...
//funcao que abre um arquivo e le o nome, as notas e o RA dos alunos e os adiciona em um vetor
...
//funcao que retorna as notas do aluno considerando a porva optativa caso seja necessario
...
//funcao que cria um arquivo txt listando todos os alunos na ordem em que eles foram adicionados no vetor
void criaAtual(int &n, tAlunoEntrada *vetAlunos);

//funcao que converte uma string para lower case
char* toLower(char* s);

//funcao que copia um vetor para outro (usado para ordenar ou pesquisar em um vetor copia no lugar do original a fim de nao alterar a ordem original de adicao dos alunos ou a formatacao original de seus nomes)
